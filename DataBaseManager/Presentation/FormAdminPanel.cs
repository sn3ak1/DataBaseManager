...
namespace DataBaseManager.Presentation
{
    public partial class FormAdminPanel : Form
    {
        public FormAdminPanel()
        {
            ...
            comboBox2.Items.AddRange(UserController.GetRoles());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            UserController.DeleteUser((User)listBox1.SelectedItem);
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            foreach (var user in ((Role)comboBox1.SelectedItem).Users)
            {
                UserController.DeleteUser(user);
            }
            UserController.DeleteRole((Role)comboBox1.SelectedItem);
        }
